			...
			<div class="ah-checkout__sidebar">
				...
				<div class="ah-checkout-summary">
					...
					<ul class="ah-checkout-trust">
						<li class="ah-checkout-trust__item">
							<svg class="ah-checkout-trust__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
							<?php esc_html_e( 'תשלום מאובטח 100% — הצפנת SSL', 'alwayshere-child' ); ?>
						</li>
						<li class="ah-checkout-trust__item">
							<svg class="ah-checkout-trust__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
							<?php esc_html_e( 'החזרה מלאה תוך 30 יום', 'alwayshere-child' ); ?>
						</li>
						<li class="ah-checkout-trust__item">
							<svg class="ah-checkout-trust__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="1" y="3" width="15" height="13"/><path d="M16 8h4l3 3v5h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
							<?php esc_html_e( 'משלוח מהיר עד 3 ימי עסקים', 'alwayshere-child' ); ?>
						</li>
					</ul>
