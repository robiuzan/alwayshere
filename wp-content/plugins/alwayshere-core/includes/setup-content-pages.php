...
<h2>6. הגבלת אחריות לנזקים</h2>
<p>Always Here לא תישא בכל אחריות לנזקים ישירים, עקיפים, מקריים, תוצאתיים או מיוחדים העלולים להיגרם כתוצאה משימוש במוצר, לרבות:</p>
<ul>
<li>שימוש לא תקין, לא מיועד, או בניגוד להוראות הטיפול והשימוש</li>
<li>שימוש על ידי ילדים מתחת לגיל המומלץ שצוין על המוצר</li>
<li>תגובות אלרגיות לחומרים — מומלץ לבדוק את רכיבי המוצר טרם השימוש</li>
<li>נזק שנגרם כתוצאה מאחסון לא נכון, חשיפה לחום, לחות, או אור שמש ישיר</li>
<li>שוני בגוון הדפסה לעומת הצגה על המסך — בשל שוני בין צגים וסוגי חומרים</li>
<li>שינויים, תיקונים, או פירוק המוצר שלא בוצעו על ידי החברה</li>
</ul>
<p>אחריות החברה מוגבלת, בכל מקרה, לסכום ששולם בפועל עבור המוצר הספציפי נשוא הדרישה, בכפוף לחוק הגנת הצרכן הישראלי.</p>
<p><strong>הערה לגבי צבעי הדפסה:</strong> בשל הבדלים בין צגי מחשב, הגדרות מסך, וחומרי הדפסה שונים, ייתכנו הבדלים קלים בגוון הצבע בין התצוגה הדיגיטלית למוצר הסופי. הבדלים אלה אינם מהווים פגם ואינם מזכים בהחזרה.</p>
